...
public class HWLOC {
	...
	public static final HwlocMEMBindFlags HWLOC_MEMBIND_UNKNOWN = HwlocMEMBindFlags.HWLOC_MEMBIND_UNKNOWN;
	public static final HwlocMEMBindFlags MEMBIND_PROCESS = HwlocMEMBindFlags.HWLOC_MEMBIND_PROCESS;
	public static final HwlocMEMBindFlags MEMBIND_THREAD = HwlocMEMBindFlags.HWLOC_MEMBIND_THREAD;
	public static final HwlocMEMBindFlags MEMBIND_STRICT = HwlocMEMBindFlags.HWLOC_MEMBIND_STRICT;
	public static final HwlocMEMBindFlags MEMBIND_MIGRATE = HwlocMEMBindFlags.HWLOC_MEMBIND_MIGRATE;
	public static final HwlocMEMBindFlags MEMBIND_NOCPUBIND = HwlocMEMBindFlags.HWLOC_MEMBIND_NOCPUBIND;
	public static final HwlocMEMBindFlags MEMBIND_BYNODESET = HwlocMEMBindFlags.HWLOC_MEMBIND_BYNODESET;
	public static final HwlocMEMBindPolicy MEMBIND_POLICY_UNKNOWN = HwlocMEMBindPolicy.HWLOC_MEMBIND_UNKNOWN;
	public static final HwlocMEMBindPolicy MEMBIND_DEFAULT = HwlocMEMBindPolicy.HWLOC_MEMBIND_DEFAULT;
	public static final HwlocMEMBindPolicy MEMBIND_FIRSTTOUCH = HwlocMEMBindPolicy.HWLOC_MEMBIND_FIRSTTOUCH;
	public static final HwlocMEMBindPolicy MEMBIND_BIND = HwlocMEMBindPolicy.HWLOC_MEMBIND_BIND;
	public static final HwlocMEMBindPolicy MEMBIND_INTERLEAVE = HwlocMEMBindPolicy.HWLOC_MEMBIND_INTERLEAVE;
	public static final HwlocMEMBindPolicy MEMBIND_NEXTTOUCH = HwlocMEMBindPolicy.HWLOC_MEMBIND_NEXTTOUCH;
	public static final HwlocMEMBindPolicy MEMBIND_MIXED = HwlocMEMBindPolicy.HWLOC_MEMBIND_MIXED;
